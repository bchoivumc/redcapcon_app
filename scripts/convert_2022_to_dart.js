...
async function convertToDart() {
  const json = await fs.readFile(
    '/Users/user/Documents/projects/redcapcon_beta/scripts/schedule_2022_parsed.json',
    'utf-8'
  );
  ...
  await fs.writeFile(
    '/Users/user/Documents/projects/redcapcon_beta/lib/data/mock_data_2022.dart',
    dartCode
  );
