/**
 * Web scraper for REDCap Conference schedule using Puppeteer
 *
...
async function scrapeSchedule() {
  ...
  try {
    ...
    await fs.writeFile('/Users/user/Documents/projects/redcapcon_beta/scripts/schedule_rendered.html', html);
